...
_Static_assert(sizeof(usb_device_dpram_t) == USB_DPRAM_MAX, "");
_Static_assert(offsetof(usb_device_dpram_t, epx_data) == 0x180, "");
...
_Static_assert(sizeof(usb_host_dpram_t) == USB_DPRAM_MAX, "");
_Static_assert(offsetof(usb_host_dpram_t, epx_data) == 0x180, "");
...
_Static_assert( USB_HOST_INTERRUPT_ENDPOINTS == 15, "");
